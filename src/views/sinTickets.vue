...
<script>
  export default {
    ...
    methods: {
      /**接收Login界面数据**/
      getInfo(){
        this.queryParams.takeoffPlace = this.$route.query.takeoffPlace;
        this.queryParams.arrivalPlace = this.$route.query.arrivalPlace;
        this.queryParams.takeoffDate = this.$route.query.takeoffDate;
      },
      /** 查询航班列表 */
      async getList() {
        // this.loading = true;
